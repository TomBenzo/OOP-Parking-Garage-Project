class Garage():
    ...
    def GetTicket(self):
        if self.tickets:
            ...
            self.current[self.tickets[0]] = 'unpaid' #a dictionary holding a list of available tickets at index [0] which is 1 in the given list, after taking in user input
